...
function ButtonSecondary({
  ...
  return (
    <Comp
      ...
      className={cn(
        buttonSecondaryVariants({ variant, size }),
        "relative rounded-lg group",
        className
      )}
      style={{
        // DEFAULT/HOVER/PRESSED: Зовнішній шар завжди #E2E4E4
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "9px",
          boxShadow: "rgba(42, 49, 81, 0.12) 0px 1px 2px 0px",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          background: "linear-gradient(rgb(255, 255, 255) 0%, rgb(254, 254, 254) 100%)",
          borderRadius: "8px",
        }}
      />
